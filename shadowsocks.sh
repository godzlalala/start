...
function pre_install(){
    ...
    read -p "(Default password: nibabazdl):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="nibabazdl"
    echo
    echo "---------------------------"
    ...
    read -p "(Default port: 137):" shadowsocksport
    [ -z "$shadowsocksport" ] && shadowsocksport="137"
